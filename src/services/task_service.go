...
func(db* DB) GetTask(id int, assigneeId int, title string, groupId int) (tasks []models.Task ,err error) {
...
func (db *DB) CreateTask(task models.Task, assigneeId int) error {
